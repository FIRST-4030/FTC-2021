...
public class TFODMain extends OpMode {
    ...
    private Matrix4f lensLocalRotation = Matrix4f.matMul(Matrix4f.matMul(Matrix4fBuilder.buildRotX(-50), Matrix4fBuilder.buildRotY(-185)), Matrix4fBuilder.buildRotZ(180));
